...
export function RollButton({
  ...
  const variantClasses = {
    ...
    secondary:
      'bg-amber-100/80 dark:bg-[#12151f]/90 hover:bg-amber-200/80 dark:hover:bg-[#181d2b] text-slate-800 dark:text-slate-100 border border-amber-300/60 dark:border-yellow-400/20 hover:border-amber-400 dark:hover:border-yellow-400/50 backdrop-blur-md hover:text-amber-800 dark:hover:text-yellow-400',
    outline:
      'bg-transparent hover:bg-amber-100/50 dark:hover:bg-yellow-400/10 text-amber-700 dark:text-yellow-400 border border-amber-400/50 dark:border-yellow-400/40 hover:border-amber-500 dark:hover:border-yellow-300',
    ghost:
